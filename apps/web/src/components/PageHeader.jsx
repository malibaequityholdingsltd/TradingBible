...
export default function PageHeader({ icon: Icon, kicker, description, actions, className = '' }) {
  return (
    <div className={`mb-6 flex flex-wrap items-start justify-between gap-4 overflow-hidden rounded-2xl border border-[#d4af37]/15 bg-gradient-to-br from-[#d4af37]/[0.08] via-[#0f0f14]/60 to-transparent p-4 sm:p-5 ${className}`}>
