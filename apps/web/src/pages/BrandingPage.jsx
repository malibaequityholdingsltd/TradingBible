        ...
        <form onSubmit={save} className="glass rounded-2xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div><label className="mb-1.5 block text-xs text-[#8a8577]">{t('brd.accent')}</label>
        ...
        <div className="glass rounded-2xl p-6">
          ...
          <div className="overflow-hidden rounded-2xl border border-white/10" style={{ background: form.primaryColor }}>
            <div className="flex items-center gap-3 border-b border-white/10 px-5 py-4">
              ...
              <span className="text-lg font-semibold text-white">{form.companyName || t('brd.companyFb')}</span>
            </div>
            <div className="px-5 py-8">
              <h4 className="text-xl font-bold text-white">{form.tagline || t('brd.taglineFb')}</h4>
              <p className="mt-2 text-sm text-white/60">{t('brd.rebranded')}</p>
